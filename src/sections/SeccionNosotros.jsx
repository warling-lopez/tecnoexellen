const SeccionNosotros = () => {
  return (
    <div className="bg-blue-950 text-white flex justify-around p-2">
      <div className="p-3 gap-1 flex flex-1 flex-col">
        <h2 className="text-gray-300 text-2xl font-bold">Sobre Nosotros</h2>
        <hr />
        <h2 className="font-bold text-gray-400 text-xl">¿Qué es TecnoExcellen?</h2>
        <p className="pl-5">
      ...
      <div className="bg-white flex flex-1 flex-col rounded-xl border border-2-gray-300 p-2 items-center text-black gap-2">
          <img className="rounded-full w-[200px] h-[200px] shadow-lg" src="/OIP.jpeg" alt="" />
          <h2 className="text-2xl text-gray-600">Nombre</h2>
