    ...
    <div className="bg-gray-50 py-16">
      <div className="container mx-auto px-4">
        <div className="mb-12 flex flex-col items-center">
          <h2 className="text-4xl font-extrabold text-center text-gray-800 gap-2">
            ¿Necesitas innovación? ¡Nosotros te la brindamos!
          </h2>
          <span className="text-center text-xl">Aquí puedes observar nuestros diferentes servicios.</span>
        </div>
